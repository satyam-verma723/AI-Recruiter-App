...
const CandidateList = ({ candidateList }) => {
    return (
        <div className=''>
            <h2 className='font-bold p-5'>Candidates ({candidateList?.length})</h2>
            {
                candidateList?.map((candidate, index) => (
                    <div key={index} className='p-5 flex gap-3 items-center justify-between bg-white rounded-lg bg-white'>
